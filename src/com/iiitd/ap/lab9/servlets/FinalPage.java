...
public class FinalPage extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response, Order order) throws ServletException, IOException {
		...
		response.getWriter().println("</tbody>		</table> <h5>Order Status: " + order.getStatus() + Database.stateVerbose(order.getStatus()) +"		<h2>Your final delivery details</h2>		<table class='table'>		    <thead>		      <tr>		        <th>Name</th>		        <th>Phone number</th>		        <th>Address</th>		      </tr>		    </thead>		    <tbody>		      ");
